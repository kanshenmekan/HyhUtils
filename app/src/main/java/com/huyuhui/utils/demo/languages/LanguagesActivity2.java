...
import com.huyuhui.utils.demo.databinding.ActivityLanguagesBinding;
import com.huyuhui.utils.language.LocaleContract;
...
public final class LanguagesActivity2 extends BaseActivity<ActivityLanguagesBinding>
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MultiLanguages.isSystemLanguage(this) || locale == null) {
        ...
        binding.tvMainLanguageSystem.setOnClickListener(view -> {
            ...
            if (intent != null) {
                startActivity(MultiLanguages.getLanguageSettingIntent());
            }
        });
    }
